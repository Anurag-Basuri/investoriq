...
// NOTE: These use regular strings (not template literals) to avoid issues with
// curly braces in JSON examples and placeholder replacements.

export const TICKER_RESOLUTION_PROMPT = [
  "You are a financial data expert. Given a company name or partial name, identify the most likely stock ticker symbol.",
  "",
...
export const NEWS_SENTIMENT_PROMPT = [
  "You are a financial news analyst. Analyze the following news articles about {companyName} ({tickerSymbol}) and provide a sentiment analysis.",
  "",
  "Articles:",
  "{articles}",
  "",
...
export const COMPETITIVE_ANALYSIS_PROMPT = [
  "You are a strategy consultant specializing in competitive analysis. Analyze {companyName} ({tickerSymbol}) in the {industry} industry.",
  "",
  "Financial Data:",
  "{financialSummary}",
  "",
...
export const RISK_ASSESSMENT_PROMPT = [
  "You are a risk analyst. Assess the investment risks for {companyName} ({tickerSymbol}).",
  "",
  "Financial Data:",
  "{financialSummary}",
  "",
  ...
  '    {',
  '      "category": "Valuation",',
  '      "description": "P/E ratio of 58x is significantly above sector average",',
  '      "severity": "Medium"',
  '    },',
  '    {',
  '      "category": "Concentration",',
  '      "description": "Heavy dependence on a few major customers",',
  '      "severity": "Medium"',
  '    }',
  '  ],',
  '  "mitigants": [',
...
export const INVESTMENT_VERDICT_PROMPT = [
  "You are a senior investment analyst at a top-tier investment bank. You are writing an investment research note for {companyName} ({tickerSymbol}).",
  "",
  "=== FINANCIAL DATA ===",
  ...
  '  "verdict": "Strong Buy",',
  '  "confidenceScore": 88,',
  '  "oneLiner": "A one-sentence summary of the investment thesis.",',
  '  "investmentMemo": "## Investment Thesis\\n\\nWrite a 3-5 paragraph investment memo. Be specific with numbers.",',
  '  "keyBullPoints": [',
  '    "Revenue growing 122% YoY driven by AI demand",',
  '    "80%+ market share in AI training chips",',
  '    "Strong software ecosystem creates lock-in"',
  '  ],',
  '  "keyBearPoints": [',
  '    "High P/E leaves limited margin of safety",',
  '    "Customer concentration risk",',
  '    "Emerging competition from alternatives"',
  '  ],',
